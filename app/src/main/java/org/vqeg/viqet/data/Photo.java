...
public class Photo implements Serializable
{
	...
	public void setOutputCategory(String outputCategory)
	{
		...
		{
			this.outputCategories = new ArrayList<String>();
		}
		if(!this.outputCategories.contains(outputCategory))
		{
			this.outputCategories.add(outputCategory);
		}
	}
	...
	public void clear()
	{
		...
		this.state = Photo.State.NO_PHOTO;
	}
